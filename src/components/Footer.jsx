          ...
          <div className="mb-8 md:mb-0">
            <a href="/" className="block" aria-label="Home">
              <img
                ...
                alt="Logo"
                className="h-24 w-24 rounded-full object-cover border-2 border-gray-200 hover:border-gray-300 transition-colors"
              />
            </a>
            <h6 className="text-gray-900 font-semibold ml-6">Kumar</h6>
          </div>
